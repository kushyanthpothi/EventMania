...
import { IoCheckmarkCircle, IoPerson, IoSchool, IoBusiness, IoSparkles } from 'react-icons/io5';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (role === USER_ROLES.STUDENT) {
                ...
                userData.collegeLocation = formData.collegeLocation;
